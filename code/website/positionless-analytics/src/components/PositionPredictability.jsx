export default function PositionPredictability() {
  return (
    <section className="w-full my-8">
      <h2 className="text-xl font-semibold mb-4">
        Position Predictability Over Time
      </h2>
      ...
      >
        ...
        <div style={{ minWidth: 0 }}>
          <img
            src="/Position Prediction AUC Over Time.svg"
            alt="Position Prediction AUC Over Time"
            style={{
              width: "100%",
              display: "block",
              borderRadius: "8px",
